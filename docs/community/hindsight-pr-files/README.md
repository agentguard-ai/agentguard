...
**Storage = evidence, NOT authority.** A stored ALLOW cannot authorize a future action. Every request gets fresh deterministic evaluation. Memory informs; it doesn't permit.
